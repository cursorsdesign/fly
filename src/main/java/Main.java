    ...
    private static class HelloTriangleApplication {
        ...
        private void createGraphicsPipeline() {
            ...
            try(MemoryStack stack = stackPush()) {
                ...
                ShaderSPIRVUtils.SPIRV vertShaderSPIRV = ShaderSPIRVUtils.compileShaderFile("shaders/26_shader_depth.vert", ShaderSPIRVUtils.ShaderKind.VERTEX_SHADER);
                ShaderSPIRVUtils.SPIRV fragShaderSPIRV = ShaderSPIRVUtils.compileShaderFile("shaders/26_shader_depth.frag", ShaderSPIRVUtils.ShaderKind.FRAGMENT_SHADER);
        ...
        private void createTextureImage() {
            ...
            try(MemoryStack stack = stackPush()) {
                ...
                String filename = Paths.get(getFileFromResource("textures/chalet.jpg")).toString();

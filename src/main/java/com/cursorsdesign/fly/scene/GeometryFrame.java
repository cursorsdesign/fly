...
public class GeometryFrame extends Frame {
    private int width ,height; float dpi; int xpos, ypos;
    @Override
    public void main(Canvas canvas, int width, int height, float dpi, int xpos, int ypos) {
        this.drawExemple(canvas,width,height,dpi,xpos,ypos);
    }

    public void drawExemple(Canvas canvas, int width, int height, float dpi, int xpos, int ypos){

...
public class ImagesFrame extends Frame {
    ...
    public void main(Canvas canvas, int width, int height, float dpi, int xpos, int ypos) {
        ...
        canvas.translate(170, 0);
        canvas.drawImageRect(ducks, Rect.makeXYWH(300, 300, 40, 40), Rect.makeXYWH(0, 0, 160, 160), new Paint().setFilterQuality(FilterQuality.HIGH), false);
        canvas.translate(170, 0);
        canvas.restore();
